...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/t5fXuIcmZt)
...
```sh
npx nx serve ecommerce-shop
```

To create a production bundle:

```sh
npx nx build ecommerce-shop
```

To see all available targets to run for a project, run:

```sh
npx nx show project ecommerce-shop
```
